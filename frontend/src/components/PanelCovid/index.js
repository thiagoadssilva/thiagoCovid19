      ...
      <ContainerFilter>
        ...
        {!displayControlState &&
          <ContainerFilterSearch>
            ...
            <ContainerSelect>
              <select style={{ backgroundColor: '#85C3FF' }} onChange={handleChangeSelectState} className="browser-default custom-select">
        ...
        {!displayControlCountry &&
          <ContainerFilterSearch>
            ...
            <ContainerSelect>
              <select style={{ backgroundColor: '#85C3FF' }} onChange={handleChangeSelectCountry} className="browser-default custom-select">
                <option value="">Selecione</option>
